Namespace MVVMExpenses.Common.Views.Transaction
    Partial Public Class TransactionsView
        ...
        Private Sub InitializeComponent()
            ...
            Me.gridControl1.Size = New System.Drawing.Size(730, 363)
            ...
            Me.ribbonControl1.Size = New System.Drawing.Size(730, 140)
            '
            'bbiNew
            '
            ...
            'mvvmContext1
            '
            Me.mvvmContext1.BindingExpressions.AddRange(New DevExpress.Utils.MVVM.BindingExpression() {DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(MVVMExpenses.ViewModels.TransactionCollectionViewModel), "New", Me.bbiNew), DevExpress.Utils.MVVM.BindingExpression.CreateParameterizedCommandBinding(GetType(MVVMExpenses.ViewModels.TransactionCollectionViewModel), "Edit", "SelectedEntity", Me.bbiEdit), DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(MVVMExpenses.ViewModels.TransactionCollectionViewModel), "DeleteAll", Me.bbiDelete), DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(MVVMExpenses.ViewModels.TransactionCollectionViewModel), "Close", Me.bbiClose), DevExpress.Utils.MVVM.BindingExpression.CreateCommandBinding(GetType(MVVMExpenses.ViewModels.TransactionCollectionViewModel), "Refresh", Me.bbiRefresh)})
            Me.mvvmContext1.ContainerControl = Me
            Me.mvvmContext1.ViewModelType = GetType(MVVMExpenses.ViewModels.TransactionCollectionViewModel)
            '
            'TransactionsView
            '
            ...
            Me.Name = "TransactionsView"
            Me.Size = New System.Drawing.Size(730, 363)
